  ...
  return (
    ...
    >
      <Box>
        ...
        <Box display={'flex'} justifyContent={'center'} mt="7" columnGap={'8'}>
          <Link href="https://www.youtube.com/@sustan_sustan" target={'_blank'}>
            <Image
          ...
          <Link href="https://www.facebook.com/sasano.kento" target={'_blank'}>
            <Image
